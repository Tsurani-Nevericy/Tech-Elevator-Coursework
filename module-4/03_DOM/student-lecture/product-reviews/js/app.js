...
function setPageTitle() {  
  // #page-title > span
  let node = document.getElementById('page-title');
  let pageTitleNode = node.querySelector('span.name');
  pageTitleNode.innerText = name;
}
...
function setPageDescription() {
  ...
  let descriptionNode = node.querySelector('p.description');
...
function displayReviews() {
  ...
  reviews.forEach((review)=>{
    ...
    mainNode.insertAdjacentElement('beforeend', container);
...
function addReviewer(parent, name) {
  ...
  parent.insertAdjacentElement('beforeend', reviewer);
}
