...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let allNumberButtons = document.getElementsByClassName('number');
  for (let i = 0; i < allNumberButtons.length; i++){
    let numberButton = allNumberButtons[i];
  ...
  let decimalButtons = document.getElementsByClassName('decimal');
  let decimalButton = decimalButtons[0];
  ...
  let clearButtons = document.getElementsByClassName('all-clear');
  let clearButton = clearButtons[0];
  ...
  let allOperatorButtons = document.getElementsByClassName('operator');
  for (let i = 0; i < allOperatorButtons.length; i++){
    let operatorButton = allOperatorButtons[i];
  ...
  let equalButtons = document.getElementsByClassName('equal-sign');
  let equalButton = equalButtons[0];
