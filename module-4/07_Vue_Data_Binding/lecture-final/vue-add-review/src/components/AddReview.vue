      ...
      <div class="col-7">
        <form v-on:submit.prevent="saveReview">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="Enter title" v-model.trim.lazy.number="review.title">
          </div>
          <div class="form-group">
            <label for="reviewer">Reviewer</label>
            <input type="text" class="form-control" id="reviewer" placeholder="Enter reviewer's name" v-model="review.reviewer">
          </div>
          <div class="form-group">
